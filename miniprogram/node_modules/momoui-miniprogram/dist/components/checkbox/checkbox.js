...
var defaultIcon = { checked: 'checkbox-marked', unchecked: 'checkbox-blank-outline' };
Component({
    ...
    observers: Object.assign(Object.assign({}, (0, _utils.ObserversForControlledPropsByAncestor)(controlledProps)), {
        indeterminate: function indeterminate(_indeterminate) {
            if (_indeterminate) {
                var icon = this.data.icon;

                this.setData({ icon: Object.assign(Object.assign({}, icon), { checked: 'checkbox-intermediate' }) });
            }
        }
    }),
    options: {
