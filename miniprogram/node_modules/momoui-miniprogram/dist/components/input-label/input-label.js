...
var controlledProps = ['color', 'disabled', 'error', 'focus', 'margin', 'required', 'variant'];
Component({
    ...
    methods: {
        _onBlur: function _onBlur(params) {
            if (!this._propIsSet || !this._propIsSet.focus) {
                this.setData(Object.assign({ focus: false }, params));
            }
        },
        _onFocus: function _onFocus(params) {
            if (!this._propIsSet || !this._propIsSet.focus) {
                this.setData(Object.assign({ focus: true }, params));
            }
        },
        ...
        _SetShrink: function _SetShrink(params) {
            this.setData(params);
        }
    },
