...
Component({
    ...
    methods: {
        _BackdropClick: function _BackdropClick(e) {
            var _data = this.data,
                disableBackdropClick = _data.disableBackdropClick,
                onBackdropClick = _data.onBackdropClick;
        ...
        _CatchTap: function _CatchTap() {},
        _GenTemplateData: function _GenTemplateData(params) {
            this._initTemplateData = true;

            var _ref = params || this.data,
                anchor = _ref.anchor,
            ...
            var _startStyle = 'transform: translate' + direction + '(' + translate + 'px);';
            ...
            this.setData({ _templateData: _templateData, _startStyle: _startStyle, _transitionStyle: _transitionStyle });
        }
    },
    observers: {
        'anchor, elevation, mClass, mStyle, position, width, height, variant': function anchorElevationMClassMStylePositionWidthHeightVariant(anchor, elevation, mClass, mStyle, position, width, height, variant) {
            this._GenTemplateData({
                anchor: anchor, elevation: elevation, mClass: mClass, mStyle: mStyle, position: position, width: width, height: height, variant: variant
            });
        },
        _show: function _show(show) {
            ...
            var _transitionStyle = show ? '' + _endStyle + _enterStyle : '' + _startStyle + _exitStyle;
