...
Component({
    ...
    methods: {
        _groupControlAction: function _groupControlAction(styles) {
            var _groupStyles = '';
            Object.keys(styles).forEach(function (styleKey) {
                _groupStyles = '' + _groupStyles + styleKey + ':' + styles[styleKey] + ';';
            });
            this.setData({ _groupStyles: _groupStyles });
        }
    },
    observers: {
        'src, icon': function srcIcon(src, icon) {
            var _iconStyle = '';
            if (src) {
            ...
            this.setData({ _iconStyle: _iconStyle });
        }
    },
    options: {
        virtualHost: true,
