...
Component({
    ...
    lifetimes: {
        created: function created() {
            ...
            if (!this._ArrangeActions) {
                this._ArrangeActions = (0, _utils.debounce)(function () {
                    var newActions = _this.data._pureActions;
                    if (newActions.length > 0) {
                        _this._hideInactiveAction = newActions.length > 3;
    ...
    relations: {
        '../bottom-navigation-action/bottom-navigation-action': {
            ...
            unlinked: function unlinked(target) {
                var _targetIndex = this.data._pureActions.findIndex(function (item) {
                    return item === target;
                });
    ...
    observers: {
        'showLabels, value, _pureActions': function showLabelsValue_pureActions() {
            if (this._ArrangeActions) {
