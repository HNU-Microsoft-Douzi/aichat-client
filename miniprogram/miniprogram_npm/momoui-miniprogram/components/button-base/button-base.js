...
exports.default = Behavior({
    methods: {
        _openTypeEvent: function _openTypeEvent(e) {
            ...
            this.triggerEvent(_utils.openTypeMap[openType], e.detail, {
                bubbles: true,
                composed: true,
                capturePhase: false
            });
...
var _rippleBase = __webpack_require__(10);

var _rippleBase2 = _interopRequireDefault(_rippleBase);

var _openType = __webpack_require__(11);
...
Component({
    behaviors: [_muiBase2.default, _rippleBase2.default, _openType2.default, 'wx://form-field-button'],
    properties: {
        appParameter: {
            type: String,
            value: ''
